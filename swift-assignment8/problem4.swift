...
func main() {
    ...
    print(TextExtension.convertStringToInt(word: "Alper") ?? "Error")
    print(TextExtension.isItAnEmail(word: "test@gmail.com"))
    print(TextExtension.isItAnEmail(word: "asdwrkf"))
    print(TextExtension.validatePassword(password: "1238892"))
